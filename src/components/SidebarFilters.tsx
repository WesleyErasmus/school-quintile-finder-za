  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full text-sm text-white font-semibold tracking-wide rounded-xl bg-indigo-600 border border-1 border-gray-200 px-5 py-3 hover:bg-indigo-500 lg:hidden"
      >
        Select a Filter
      </button>
